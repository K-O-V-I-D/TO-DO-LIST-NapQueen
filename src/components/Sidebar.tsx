    ...
    <Container>
      ...
      >
        ...
        >
          ...
          <h2>
            <span style={{ color: "#6dde2eb3" }}>To-Do</span>
          </h2>
        </LogoContainer>
        ...
        <StyledMenuItem
          translate="no"
          onClick={() => {
            window.open("https://github.com/K-O-V-I-D/TO-DO-LIST-NapQueen");
          }}
        >
          <GitHub /> &nbsp; Github{" "}
        ...
        >
          ...
          <CreditsContainer translate="no">
            ...
            <a
              ...
              href="https://github.com/K-O-V-I-D/TO-DO-LIST-NapQueen"
            >
              KOVID TIWARI
            </a>
          </CreditsContainer>
...
const Container = styled.div`
  ...
  top: 14px;
  z-index: 900;
  background-color: #0d331b; /* Update to the desired combination of black and green */
  padding: 10px;
  border-radius: 10px;
...
const StyledSwipeableDrawer = styled(SwipeableDrawer)`
  & .MuiPaper-root {
    ...
    box-shadow: none;
    padding: 4px;
    background: #0d331b; /* Update to the desired combination of black and green */
    z-index: 999;
...
const StyledMenuItem = styled(MenuItem)`
  ...
  display: flex;
  font-weight: 500;
  color: #ffffff; /* Update text color if needed */
  align-items: center;
  gap: 6px;
  ...
  &:hover {
    background-color: #1e7430; /* Update to the desired hover background color */
...
const CreditsContainer = styled.div`
  font-size: 12px;
  margin: 0;
  color: #ffffffa1; /* Update text color if needed */
  text-align: center;
  display: flex;
  align-items: center;
