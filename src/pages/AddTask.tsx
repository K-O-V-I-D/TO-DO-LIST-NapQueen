...
// Define styled button component with black-green gradient
...
const AddTask = () => {
  ...
  const blackGreenColor = "#00ff00"; // Define black-green color
  ...
  const [color, setColor] = useStorageState<string>(blackGreenColor, "color", "sessionStorage");
